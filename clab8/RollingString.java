...
class RollingString{
    ...
    public int hashCode() {
        int hashcode = 0;
        for (char c : rollCharQueue) {
            hashcode = (hashcode * UNIQUECHARS + (int) c) % PRIMEBASE;
        }
        return hashcode;
    }
}
