...
public class TestClorus {
    ...
    public void testMove() {
        ...
        cl.move();
        assertEquals(1.17, cl.energy(), 0.01);
        cl = new Clorus(0.02);
        cl.move();
        assertEquals(0.0, cl.energy(), 0.01);
    }
    ...
    public void testStay() {
        ...
        cl.stay();
        assertEquals(1.29, cl.energy(), 0.01);
    }
